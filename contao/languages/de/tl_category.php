...
$lang = &$GLOBALS['TL_LANG']['tl_category'];
 ...
 * Buttons
 */
$lang['new']        = ['Neue Kategorie', 'Kategorie erstellen'];
$lang['show']       = ['Details der Kategorie', 'Zeigt die Details der Kategorie ID %s'];
$lang['edit']       = ['Kategorie bearbeiten', 'Kategorie ID %s bearbeiten'];
$lang['cut']        = ['Kategorie verschieben', 'Kategorie ID %s verschieben'];
$lang['copy']       = ['Kategorie kopieren', 'Kopiert die Kategorie ID %s'];
$lang['copyChilds'] = ['Unterkategorien kopieren', 'Kopiert die Kategorie ID %s mit den Unterkatehgorien'];
$lang['delete']     = ['Kategorie löschen', 'Löscht die Kategorie ID %s'];
